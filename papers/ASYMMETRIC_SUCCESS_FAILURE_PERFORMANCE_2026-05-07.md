...
| 3 | **Tralse five-valued logic (MR-gate scheme, canonical per Brandon 2026-05-08)** | categorical {Nonsense, Moot, True, False, Indeterminate}; generated by MR1 (Gate 1: detects Double Tralse and discards) + MR2 (Gate 2: T/F/I for sufficiently coherent statements); compact-4 = {T, F, I, DT} with DT compartmentalized into Nonsense (DT proper, "indeterminate indeterminacy") + Moot. **Classical T/F are rejected as sloppy labels — all statements carry universal Tralse-quality.** | `FIVE_VALUED_TRUTH_TRALSE_INDETERMINATE_DISTINCTION_URB_528.md`, `TI_SIGMA_FIVE_AXIS_TRUTH_RICHNESS_REVIEW_2026-05-07.md` §4 (corrected). The {TT, TI, TF, DT, EV} ternary-digit scheme of `urb_628` §4 is a separate PD-coordinate notation, not the truth-value taxonomy. |
