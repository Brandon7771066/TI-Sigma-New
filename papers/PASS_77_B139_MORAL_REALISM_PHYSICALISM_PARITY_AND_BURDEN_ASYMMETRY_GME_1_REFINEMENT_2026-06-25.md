...
**Re-reading the residue through the Existence-Footprint tenet (alignment note).** One caution against mis-stating that open question: in TI Sigma, *mind-independence is not the bar for being real* (graduated reality / Existence Footprint, URB #598), and moral facts are construed as **attractors embodied within minds**, not Platonic abstracta. So the quasi-realist's "projected stable shared attitudes" are **not thereby unreal** — described in framework terms they simply *are* real, mind-embodied value-attractors. The genuine "mind-independent facts **or** projected attitudes" dichotomy therefore collapses into a third, already-realist option, and the substantive residue is **not** mind-independence but whether those attractors are **agent-neutrally convergent** (one optimum binding on all minds) versus merely contingent and divergent. That convergence is the live, *tralse-real*, never-deductively-closed question (GME-1-F1) — the data-matching competitor bounds the posterior on *convergence*, not on *reality*.
