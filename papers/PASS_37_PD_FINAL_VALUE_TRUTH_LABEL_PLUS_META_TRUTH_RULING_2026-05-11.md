...
- **Form 1 — Pure base-label:** PD-final ∈ {True, False, Indeterminate, Double Tralse} (the canonical base-4 per `MR_TRUTH_LABELS_CANONICAL_RULING_2026-05-08.md`).
...
- "PD-final = Double Tralse ⊗ MT-S1-high-stakes" (DT value with stakes-modulated handling).
