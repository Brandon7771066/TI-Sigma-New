...
**LCC as the correct replacement**: The Law of Correlational Causation (LCC) measures the internal consistency of a framework — the degree to which its components mutually support each other rather than undermine each other. This is a real property of a belief system, in principle measurable, and derived from the physics of the system (BOK relationships, information-theoretic coherence) rather than assigned by convention.
