...
- **Result (RETRIEVED 2026-05-27):** **S = 2.7070** on real silicon — a **genuine Bell violation** (S > 2 classical bound) reaching **95.7% of the Tsirelson ceiling** (2√2 = 2.8284). Per-setting correlators E = {a0b0: +0.693, a0b1: −0.652, a1b0: +0.637, a1b1: +0.726}. Exactly the predicted regime **2 < S < 2√2**: noise/decoherence pulls the value down from the noiseless 2.828 but the classical bound is decisively broken. See `analyses/pass77_b54_ibm_hw_chsh/results.json`.
