# EMD-1 — Empiricism–Metaphysics Demarcation (physicalism is not a method; it free-rides on empiricism)
...
The achievements that physicalism takes credit for belong to **empiricism** — a *method* (disciplined conjecture-and-test) that is ancient, metaphysically neutral, and fully compatible with rejecting physicalism. **Physicalism** ("matter and energy are all there is") is a *metaphysics* bolted onto that method. It does not own the method's trophies, and at times it has actively *obstructed* the method. So the book should stop conceding physicalism the credit for science's success in the first place.

This sharpens — it does not contradict — the existing chapter, which already grants that the triumphs are triumphs of *physical method*. EMD-1 names the method (empiricism), shows it predates and outlives physicalism, and adds the historical record of physicalist gatekeeping.

## The argument

### 1. Method ≠ metaphysics

Empiricism tells you *how* to find out what is real (observe carefully, test, keep what survives). Physicalism makes a *substantive metaphysical bet* about what reality ultimately contains. You can run the entire scientific apparatus — controls, blinding, replication — without signing the physicalist creed, and most of science's founders did exactly that: **Newton, Faraday, Mendel, and Maxwell were not materialists**, and their method worked regardless. "Look how much science has accomplished" is therefore evidence *for empiricism*, not for physicalism. Crediting physicalism for it is a category error — like crediting the party in office for the weather during its term.

### 2. Empiricism is ancient; the "nothing happened before physicalism" story is a myth
...
Earlier scientific methodology is explicit, too: Ibn al-Haytham's controlled optical experiments (~1000 CE), Babylonian planetary records, Eratosthenes' measurement of the Earth.

### 3. Physicalism has *held empiricism back*

When a metaphysics fixes in advance what *kinds* of thing may be real, it becomes a gatekeeper that delays discoveries which do not fit:

- **Newtonian gravity** attacked by Cartesian mechanists as illegitimate "action at a distance" / an *occult* force (it broke contact-push matter).
- **Quantum entanglement** resisted as "spooky action at a distance."
...
- **The evidence, fairly consulted (#69):** reflexive dismissal does not survive the better data, but neither does triumphalism. *Acupuncture* (most-studied) is genuinely **contested, not debunked**: the largest *sham-controlled* synthesis — an individual-patient-data meta-analysis of ~21,000 patients (Vickers et al. 2018) — found acupuncture **statistically superior to sham** as well as to no-acupuncture for several chronic-pain conditions; NICE recommends it for chronic primary pain (2021) and Cochrane supports it for migraine prophylaxis (major-hospital uptake is context, not itself evidence). **Animal evidence (placebo CANNOT operate) — the decisive anti-"all-placebo" point:** controlled animal studies, where there is no expectation effect, show point stimulation triggers concrete physiology — adenosine/A1-receptor analgesia (Goldman et al. 2010, *Nat Neurosci*) and an anti-inflammatory vagal–adrenal reflex with mapped neuroanatomy (Torres-Rosas et al. 2014, *Nat Med*; Liu et al. 2021, *Nature*) — which a pure-placebo reading cannot explain. **Caveat the other way:** these show the *stimulation* engages real neuro-immune pathways, NOT that the "meridian/qi" theory is right; most are *electro*-acupuncture (a modern hybrid); a mouse mechanism ≠ a human clinical effect; and in human trials the true-vs-sham *margin is small* (specific-vs-placebo still debated). The animal work also has its OWN limits: removing expectation-placebo ≠ removing all preclinical confounds (handling stress, imperfect blinding, nonspecific somatosensory effects still need controlling), and the pathways may be GENERAL somatosensory/electro-neuromodulation rather than anything unique to classical acupuncture *points*. *EFT/"tapping"* has a substantial trial literature and several meta-analyses reporting benefit for anxiety/PTSD (e.g. Clond 2016); the live, unresolved questions are whether the acupoint-tapping *component* adds anything beyond the bundled exposure/breathing (dismantling studies **disagree**, not "inert") and that much positive work comes from a small circle of affiliated researchers (a fair independence caution).
...
- **Sibling of PDU-1 (B127).** PDU-1: "physical" has no fixed meaning (definitional). EMD-1: physicalism is a metaphysics that free-rides on empiricism and has obstructed it (credit + history). The §3 gatekeeping cases are the metaphysical-side mirror of PDU-1's resist-then-relabel.
- **Consistent with, does not prove, TOF-1.** EMD-1 is a *credit-and-method* correction; it lowers physicalism's standing without establishing any rival.
- **Connects to the Evidence Doctrine (EVD-1) + Authority Axis:** the energy-medicine point is exactly EVD-1's "weigh it, don't disqualify it by fiat."

## Falsifiers (OPEN)

- **EMD-1-F1.** It is shown that physicalist *metaphysics* (not merely empirical method) was actually necessary to produce the scientific achievements credited to it — i.e., the method does *not* run without the creed.
- **EMD-1-F2.** The "physicalism held empiricism back" cases are shown to be misdescribed — the resistance was not metaphysical gatekeeping but ordinary, evidence-appropriate caution.
- **EMD-1-F3.** Pre-physicalist/traditional empirical achievements are shown to be negligible or illusory once examined (the "nothing happened before" story turns out true).
