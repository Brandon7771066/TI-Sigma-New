...
| Gold MI (incoherent-when-fully-entertained, Pass-65 MI canonical definition) | Templated: liar paradox, married bachelor, square circle, 2+2=5 by definition | 100 | MI |
...
**MI failure pattern:** 22/100 MI propositions misclassified as F (rater interprets the contradiction as falsity rather than incoherence). This is consistent with Pass-77-B24 baseline (MI/MI = 83/100). Hardest category in the taxonomy, by design (Pass-65 MI canonical: inconceivability-under-mental-actualization is harder than mere falsity).
...
## 6. Asymmetric-Standards #69 Honest Disclosures
  ...
  2. **MI templates skew toward classical paradoxes** (liar, married bachelor, square circle, contradictions-by-definition). They do NOT test the harder cases where MI/MI must be distinguished from MR1 (genuine ambiguity) or MR3 (defective truth) — see Pass-67 MR-IDC-1 and Pass-70 HMR-1 refinements.
  ...
  5. **The MI failure mode (22/100 → F) is real.** Even competent raters confuse "incoherent-when-fully-entertained" with "false." This is a known difficulty of the canonical Pass-65 MI criterion and is a target for prompt refinement (Pass-78+).
...
## 7. Composition with Prior Canonical Corpus
  ...
  - **Confirms Pass-63-B5 LLM-rater-rebuild canonical finding** (4-label preserves κ at 3-label level while adding empirical MI-vs-I discrimination at zero κ cost). Pass-77-B26 extends this to 5-label on a 10× larger corpus with 50% authentic human-language input.
  ...
  - **Vindicates Pass-65 MI canonical refinement** (inconceivability-under-mental-actualization). MI=73% accuracy is non-trivial; binary would score 0% by construction.
