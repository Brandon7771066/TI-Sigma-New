# URB #523: Existence vs Truth — The LCC–GILE Gap and the PD's Hidden Bridge
...
- **LCC ≥ 0.85 (≈)** — the causation phase transition threshold. A claim above this value is existentially causal: the correlation has crossed the phase boundary into structural necessity. Minimum bar for a claim to carry causal weight.
- **GILE Radiant ≥ 0.93 (≈)** — the perfect True-Tralse threshold. A claim above this value achieves Radiant status — full coherence with the GILE framework's deepest principles (Goodness, Intuition, Love, Environment). The highest epistemic grade in TI Sigma.

Until this paper, both thresholds were stated as conventional approximate values with no derivation from PRIMARY CONSTANTS. This paper provides that derivation for the first time, and in doing so reveals that the gap between them encodes the same 2:1 negativity asymmetry that drives all Permissibility Distribution structure.
...
## §1: The PD's Extreme Zones and Their e-Decay Probabilities

The Permissibility Distribution assigns probabilities to five experiential zones using fractions of 15 ternary units. The most extreme zones — Terrible (worst negative) and Great (rarest positive) — follow an e-decay law with the 2:1 negativity asymmetry:

| Zone | Continuous (e-decay) | Discrete (ternary) |
|------|---------------------|-------------------|
| Terrible | P = 1/e² ≈ 0.13534 | 2/15 ≈ 0.13333 |
...
| | Value |
|-|-------|
| Derived GILE = 1 − 1/(2e²) | **0.93233** |
| Conventional GILE ≈ | **0.93** |
| Difference | 0.23pp |
