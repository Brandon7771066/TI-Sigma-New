...
- **Mendi Path B status update 2026-05-01 PM**: `papers/MENDI_PATH_B_STATUS_2026-05-01.md`. Scaffold complete on Replit; **AWAITING BRANDON LOCAL EXECUTION** (Replit has no BLE radio). Step-by-step Brandon-runnable instructions documented (5-10 min Phase 1 scan + GATT discovery + git push). Total Brandon-time ~30 min across 3-4 sessions; agent-time 5-12 hours. Honest 45% end-to-end success estimate unchanged. NOT on URB #828 critical path. Useful for future H_BFG-adjacent fNIRS experiment + 5th live-channel arm in URB #828 follow-on (post-2026-09-22) + personal biofeedback validation.
- **Pipeline tracker `PIPELINE.md` (root)**: Single-pane tracker with Brandon's open-tasks section (6 non-blocking items ordered by ease: Mendi Phase 1 scan, Biowell appointment confirm, M=5 token confirm/override, sealed-deck print, papers_browser visual check, daily H10/subjective/medication logging continuation), Gate 1/2/3/4 columns, held items, two scheduled falsification gates (2026-05-22 URB #826 §10.6 and ~2026-06-22 URB #828 v2).
