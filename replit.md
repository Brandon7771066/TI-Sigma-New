...
## URB Corpus Log
**Total URBs: 179** (as of March 27, 2026)
**Zenodo: 193 papers live** with permanent DOIs (Apache-2.0 license)

### TFEP - Tralse Free Energy Principle (#525)
- #525: TFEP = TI Sigma's universal dynamical law; every i-Cell minimizes Tralse Free Energy TF=(1-TT)^2+(1-G)^2 across its i-Boundary; i-Boundaries = topological generalization of Friston's Markov Blankets; UOP=ontology (what i-Cells ARE), TFEP=dynamics (HOW they behave); Boltzmann Identity: PD zone probabilities are the stationary distribution of TFEP at T=1/2; 4-valued correspondence: TRUE=TF=0 (Great), TRALSE=active minimization, FALSE=minimization failing, MR_PEND=TF undefined; TFEP applies at all 8 levels (quantum to CCC); reduces to Friston's FEP at Level 4; consciousness = TRALSE zone experienced from within; overall LCC=0.907 Radiant; DOI: 10.5281/zenodo.19236526; Corpus Entry #179
...
| **UOP** | Universal Ontological Principle | Foundational claim: every entity is an informationally-bounded i-Cell with 4-valued state. TFEP is the dynamical law acting on UOP's i-Cells. Together: UOP=noun, TFEP=verb. |
