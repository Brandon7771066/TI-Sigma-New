...
## URB Corpus Log
**Total URBs: 177** (as of March 27, 2026)
**Zenodo: 191 papers live** with permanent DOIs (Apache-2.0 license)

### Existence vs Truth — LCC/GILE Gap (#523)
- #523: Primary (continuous) LCC threshold = 1 − 1/e² ≈ 0.8647 (LCC score 0.9827 — Radiant); discrete-corrected LCC corollary = k − 2/15 = 2(e²−1)/15 ≈ 0.85187 (LCC score 0.9978 — Radiant, tighter rational approx of 0.85); GILE Radiant threshold = 1 − 1/(2e²) ≈ 0.93233 (LCC score 0.9975 — Radiant); Exact gap identity (follows from primary continuous LCC): GILE − LCC = [1−1/(2e²)] − [1−1/e²] = 1/(2e²) = P(Great) ≈ 1/15 = one ternary unit; (1−LCC)/(1−GILE) = P(Terrible)/P(Great) = 2:1 exactly; both thresholds transcendental (e² transcendental by Hermite 1873); philosophical meaning: "to exist is to survive the Terrible; to be True is to reach beyond the Great; the 2:1 negativity asymmetry IS the ratio between epistemology and axiology"; framework self-grounds (LCC threshold scores itself Radiant); DOI: 10.5281/zenodo.19235153; Corpus Entry #177
