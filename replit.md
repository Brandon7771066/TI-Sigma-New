...
| **TFEP** | Tralse Free Energy Principle | TI Sigma's replacement for Friston's FEP. Governs ALL i-Cells and their processes via i-Cell boundaries (TI Sigma's Markov Blanket equivalent). UOP provides the ontological foundation; TFEP provides the dynamical law that acts on it -- they are complementary, not competing |
| **UOP** | Universal Ontological Principle | The foundational claim about what i-Cells ARE. TFEP is the dynamical law governing HOW they behave. Together: UOP = ontology, TFEP = dynamics -- the TI Sigma equivalent of "what exists" + "how it moves" |
