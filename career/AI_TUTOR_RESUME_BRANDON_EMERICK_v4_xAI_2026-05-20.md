...
- **Accuracy & work ethic:** achieved 95% of developmental objectives across sessions with autism clients, ages 9–19.
- Direct one-on-one therapy; discrete-trial-training protocol adherence; session data logging; behavior-plan implementation.

### ABA Behavior Technician — Altura Care
*01/2025 – 05/2025 · Connecticut*
...
- **Statistical fallacy detection:** dual-threshold randomness benchmark (T_RAND = 0.0660, T_BORDER = 0.13534) at N = 384 with 0.00% false-positive rate over 2,000 draws; explicit Lindley-paradox immunity; 6 of 8 candidate sources passed NIST SP 800-22.
- **Published 100+ open-access research papers** on Zenodo (citable DOIs) spanning philosophy of science, AI alignment, formal logic, statistics, cognitive psychology, quantum computing, and consciousness science.
- **Public retraction within 48 hours** when a corpus sweep falsified a prior audit — documented case study in honest scientific revision.
- **Forecasting / prediction markets:** active on Kalshi (event-futures market), Collective2 (algorithmic-trading signals); multi-year backtested algorithmic-trading strategy.
...
**Logic & Formal Verification:** Lean 4 · mathlib4 · `lake` · type theory · dependent types · interactive theorem proving · proof assistants · higher-order logic · first-order logic · four-valued (Tralse) logic · named-gap formalization (Buzzard / LTE style)

**Cognitive Psychology & Cognitive Science:** UConn cognitive science · cognitive psychology · brain-computer interfaces · biometric signal processing (EEG, HRV, fNIRS) · mood modulation prototype · Tralse Success Distinction operationalization

**AI Alignment & Trainer Skills:** RLHF rubric design · chain-of-thought generation and grading · adversarial evaluation · red-teaming · falsifier specification · annotation guidelines · constitutional-AI methodology · model evaluation · alignment research · motivated-reasoning resistance · rhetorical-sleight detection

**Forecasting & Markets:** Kalshi event-futures · Collective2 algorithmic-trading signals · Alpaca trading API · multi-year backtesting · prediction-market analysis · economics (UConn Business Administration coursework)
...
**History of Science:** Popper retirement (URB-830 ratified canonical TIU = |log P(H|e)/P(H)|) · Lindbergh / Tesla historical-lineage research · Jung Cosmic-Consciousness external-anchor mapping
